...
export const ProductDetails = () => {
  ...
  //funcion para sumar cantidades en el contador de carrito
  const increaseQty = () => {
  ...
  //funcion para restar cantidades en el contador de carrito
  const decreaseQty = () => {
    const contador = document.querySelector('.count')
        ...
        <Fragment>
          ...
          <div className='row d-flex justify-content-around'>
            ...
            <div className='col-12 col-lg-5 mt-5'>
              ...
              <hr />
              <p>Estado: 
                <span id="stock_stado" className={product.inventario > 0 ? 'greenColor' : 'redColor'}>
                  {product.inventario > 0 ? ` ${product.inventario} ${product.inventario > 1 ? "disponibles" : "disponible"}` : " Agotado"}
                </span>
              </p>
              <hr />
              ...
              <hr />
              <p id="vendedor">Distribuidor: <strong>{product.Distribuidor}</strong></p>
